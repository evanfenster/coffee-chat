...
export function TermsOfService() {
  return (
    <div className="prose dark:prose-invert max-w-none">
      ...
      <p>
        By accessing or using Barista Agent, you agree to comply with and be legally bound by these Terms. If you do not agree with these Terms, please do not create an account or use our Service.
      </p>

      <h2>2. Eligibility and Account Creation</h2>
      <p>
        <strong>Eligibility:</strong> You must be at least 18 years of age and capable of entering into a binding agreement to use our Service.
      </p>
      <p>
        <strong>Account Registration:</strong> A user account is required to access and use our Service. You agree to provide accurate, current, and complete information during registration and to update such information as necessary. You are responsible for maintaining the confidentiality of your account credentials and for all activities that occur under your account.
      </p>
      ...
      <ul>
        <li><strong>Shipping Information:</strong> We collect and retain your shipping address provided during the purchase process to complete your order.</li>
        <li><strong>Payment Information:</strong> All payment data is processed exclusively by Stripe. We do not collect or store any card information.</li>
        <li><strong>Account Information:</strong> When you create an account, you provide personal details necessary to manage your account and use our Service.</li>
      </ul>
      ...
      <p className="mt-8">
        By creating an account and using Barista Agent, you acknowledge that you have read, understood, and agree to these Terms of Service and the integrated privacy practices.
      </p>
    </div>
  );
} 